...
<div class="wre-kargo-settings">
    <h2><?php echo esc_html( ucfirst( 'ptt' ) ); ?> <?php esc_html_e( 'Ayarları', 'wre-kargo-suite' ); ?></h2>
    <form method="post" action="<?php echo esc_url( admin_url( 'admin.php?page=wre-kargo-suite&carrier=ptt' ) ); ?>">
        <?php wp_nonce_field( 'wre_kargo_save_settings', 'wre_kargo_nonce' ); ?>
        <input type="hidden" name="carrier" value="ptt" />
