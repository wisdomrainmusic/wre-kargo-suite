...
<div class="wre-kargo-settings">
    <h2><?php echo esc_html( strtoupper( 'dhl' ) ); ?> <?php esc_html_e( 'Ayarları', 'wre-kargo-suite' ); ?></h2>
    <form method="post" action="<?php echo esc_url( admin_url( 'admin.php?page=wre-kargo-suite&carrier=dhl' ) ); ?>">
